...
2. Execute the setup SQL script found inside your database configuration to build the `habit_db` database and `habits` table.
3. Import the project into **Spring Tool Suite (STS)** or any Eclipse-based IDE.
4. Update the database connection credentials inside `dal.HabitDAL`.
5. Run `main.MainApp` as a **Java Application**.
